...
To try out channels now, you will need to re-install Fluvio with the [instructions on the download page](/download). This will download the channel-enabled frontend and the most recent `stable` release.
