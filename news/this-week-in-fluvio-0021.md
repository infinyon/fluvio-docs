...
Previously, if you were [developing your own connector](/connectors/cdk), creating connectors would fail because during the creation of the connector pod, Kubernetes would always try to pull from Docker Hub.
