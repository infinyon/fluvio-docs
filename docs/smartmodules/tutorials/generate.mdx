...
description: "Create a smartmodule that converts a record to uppercase."
---

Create a SmartModule that converts a record to uppercase.

### Generate SmartModule project
