...
```bash
  TOPIC         PARTITION  LEADER  MIRROR                                                                 REPLICAS  RESOLUTION  SIZE  HW  LEO  LRS  FOLLOWER OFFSETS
  mirror-topic  0          5001    c7f891c9-f1f9-4d28-b181-9777d8d07731:0:router.dev.infinyon.cloud:9005  []        Online      0 B   0   0    0    0                 []
```
...
```bash
  ...
  c7f891c9-f1f9-4d28-b181-9777d8d07731  router.dev.infinyon.cloud:9003  Online  1s
```
