...
sidebar_position: 4
title: "Array Map"
description: "ArrayMaps are used to break apart Records into smaller pieces. This can be very useful for working with your data at a fine granularity."
slug: /fluvio/smartmodules/transform/array-map
---
...
<img  src="/img/docs/references/smartmodules/smartmodule-arraymap.svg" alt="SmartModule ArrayMap" justify="center" height="190" />
