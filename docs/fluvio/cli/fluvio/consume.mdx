...
The following `fluvio consume` examples come after the [`fluvio produce` examples](/docs/fluvio/cli/fluvio/produce).
...
[filter example]: /docs/connectors/smartmodules/transformations/filter
...
[`fluvio topic create`]: /docs/fluvio/cli/fluvio/topic#fluvio-topic-create
...
[`fluvio partition list`]: /docs/fluvio/cli/fluvio/partition#fluvio-partition-list
