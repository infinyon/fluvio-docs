...
```bash
Export a profile for use in other applications. By default a fluvio config format
in toml is exported which can be used by setting environment variable FLV_PROFILE_PATH
