---
sidebar_position: 6
title: "fluvio consume"
description: "Consume data from topics using the Fluvio CLI"
slug: /fluvio/cli/consume
---
...
The following `fluvio consume` examples come after the [`fluvio produce` examples](/docs/fluvio/cli/produce).
...
[filter example]: /docs/connectors/concepts/smartmodules/transformations/filter
...
[`fluvio topic create`]: /docs/fluvio/cli/topic#fluvio-topic-create
...
[`fluvio partition list`]: /docs/fluvio/cli/partition#fluvio-partition-list
...
<Alert>
  There is no order guarantee between partitions.
</Alert>
