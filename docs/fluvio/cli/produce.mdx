...
[Map]: /docs/connectors/concepts/smartmodules/transformations/map
...
[`fluvio consume`]: /docs/fluvio/cli/consume#fluvio-consume
...
[Example 3]: /docs/fluvio/cli/produce#produce-keyvalue-records-to-multiple-partitions
...
[`consuming`]: /docs/fluvio/cli/consume
