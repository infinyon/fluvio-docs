...
* Learn more about the connector's 4 steps of transformation in [core concepts]
* For the development of your own connectors, continue on to the [Connector Development Kit docs]
