...
* Learn more about the connector's 4 steps of transformation in [core concepts](/docs/fluvio/connectors/concepts)
* For the development of your own connectors, continue on to the [Connector Development Kit docs](/docs/fluvio/connectors/cdk)
