...
More extensive examples of secrets in connectors can be seen in use with the [Http Source](/connectors/inbound/http) connector and its repo https://github.com/infinyon/http-source-connector.

In the [next section](/connectors/cdk/publish) we'll publish our connector to the Hub.
