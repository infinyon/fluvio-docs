...
See the [Transformations](/concepts/transformations) section for more information.

[connectors]: /connectors

See [Tutorials](/tutorials/http-to-sql#connector-pipeline) for examples of using transforms.
