...
The following `fluvio consume` examples come after the [`fluvio produce` examples](/cli/produce).
...
[filter example]: /smartmodules/transform/filter
...
[`fluvio topic create`]: /cli/topic#fluvio-topic-create
...
[`fluvio partition list`]: /cli/partition#fluvio-partition-list
