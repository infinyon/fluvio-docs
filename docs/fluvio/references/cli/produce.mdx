...
[Map]: /smartmodules/transform/map
...
[`fluvio consume`]: /cli/consume#fluvio-consume
...
[Example 3]: /cli/produce#produce-keyvalue-records-to-multiple-partitions
