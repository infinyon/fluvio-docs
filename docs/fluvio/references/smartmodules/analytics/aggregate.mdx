...
sidebar_position: 1
title: "Aggregate"
description: "SmartModule Aggregates are functions that define how to combine each record in a stream with some accumulated value."
slug: /fluvio/smartmodules/analytics/aggregate
---
...
<img src="/img/docs/references/smartmodules/smartmodule-aggregate.svg" alt="SmartModule Aggregate" justify="center" height="230" />
