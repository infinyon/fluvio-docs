...
[offset]: fluvio/concepts/offsets.mdx
[Fluvio Http Sink connector]: https://github.com/infinyon/http-sink-connector
[connectors configuration]: connectors/configuration.mdx
[the Fluvio CLI]: fluvio/cli/introduction.mdx
[one of the programmatic APIs]: apis/quickstart.mdx
