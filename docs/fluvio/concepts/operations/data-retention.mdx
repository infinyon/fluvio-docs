...
Retention time duration can be provided as a free-form string. Check out the [`humantime` docs] for the supported time suffixes.
...
Segment size can be provided as a free form string. Check out the [`bytesize` docs]
...
Max partition can be provided as a free-form string. Check out the [`bytesize` docs]
for the supported size suffixes.
...
[`humantime` docs]: https://docs.rs/humantime/2.1.0/humantime/fn.parse_duration.html
[`bytesize` docs]: https://github.com/hyunsik/bytesize/