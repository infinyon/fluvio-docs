...
<img src="/img/docs/concepts/architecture/client/fluvio-client.svg"
     alt="Fluvio Client"
     style={{ justify: 'center', maxWidth: '480px' }} />
...
<img src="/img/docs/concepts/architecture/client/prod-cons-before-failover.svg"
    alt="Prod/Cons Failover"
    style={{ justify: 'center', maxWidth: '475px' }} />
...
<img src="/img/docs/concepts/architecture/client/prod-cons-after-failover.svg"
...
[Admin API]: fluvio/concepts/architecture/client#admin-api
[Producer API]: fluvio/concepts/architecture/client#producer-api
[Consumer API]: fluvio/concepts/architecture/client#consumer-api
[Fluvio CLI]: fluvio/cli/introduction.mdx
[Architecture Overview]: fluvio/concepts/architecture/overview.mdx
[Apis Page]: apis/quickstart.mdx
[Election Design]: fluvio/concepts/architecture/replica-election.mdx
[Fluvio Profiles]: fluvio/cli/fluvio/profile.mdx