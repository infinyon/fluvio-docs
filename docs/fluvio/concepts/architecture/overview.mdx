...
<img src="/img/docs/concepts/architecture/overview/sc-spu.svg"
     alt="Architecture Components - SC/SPUs"
     style={{ justify: 'center', maxWidth: '500px' }} />
...
<img src="/img/docs/concepts/architecture/overview/cloud-edge-iot.svg"
     alt="DC, Cloud, Edge, IoT"
     style={{ justify: 'center', maxWidth: '580px' }} />
...
<img src="/img/docs/concepts/architecture/overview/spus.svg"
    alt="SPU produce/consume & replication"
    style={{ justify: 'center', maxWidth: '330px' }} />
...
<img src="/img/docs/concepts/architecture/overview/topic-partition.svg"
     alt="Topic/Partitions"
     style={{ justify: 'center', maxWidth: '650px' }} />
...
<img src="/img/docs/concepts/architecture/overview/storage.svg"
     alt="Data Storage"
     style={{ justify: 'center', maxWidth: '720px' }} />
...
For additional information on retention conditions, checkout [Data Retention].
...
<img src="/img/docs/concepts/architecture/overview/external-api.svg"
     alt="External APIs"
     style={{ justify: 'center', maxWidth: '500px' }} />
...
**Internal APIs** are used by the **SC** to communicate with the **SPUs** and for the **SPUs** to communicate with their peers to elect leaders and exchange replica information.

<img src="/img/docs/concepts/architecture/overview/internal-apis.svg"
     alt="Internal APIs"
     style={{ justify: 'center', maxWidth: '500px' }} />
...
[Kubernetes install]: fluvio/concepts/advanced/kubernetes.mdx
[SC Architecture]: fluvio/concepts/architecture/sc.mdx
[Replica Election]: fluvio/concepts/architecture/replica-election.mdx
[SPU Architecture]: fluvio/concepts/architecture/spu.mdx
[Replica Assignment]: fluvio/concepts/architecture/replica-assignment.mdx
[Data Retention]: fluvio/concepts/operations/data-retention.mdx