...
[Spu Group]: fluvio/concepts/architecture/sc.mdx#spu-groups
[SPU]: fluvio/concepts/architecture/sc.mdx#spus
[Topic]: fluvio/concepts/architecture/sc.mdx#topics
[Partition]: fluvio/concepts/architecture/sc.mdx#partitions