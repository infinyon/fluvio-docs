...
Ensure that the Fluvio CLI is installed and logged in to InfinyOn Cloud before proceeding. If not set up, follow the [Quick Start].
...
Manage your connectors efficiently with the [Cloud CLI].
...
[Cloud CLI]: cloud/cli/connector.mdx
[Inbound HTTP connector]: hub/connectors/inbound/http.mdx
[a cat fact API]: https://catfact.ninja
