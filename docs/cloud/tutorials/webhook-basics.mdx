...
This tutorial assumes that `fluvio` is installed, and logged-in to InfinyOn Cloud. Follow the [Quick Start](../../../fluvio/quickstart) to get set up.
...
You now know how to create and configure the output of Webhooks. Check out the [Webhook Config](../how-to/webhook-config) reference to see how to configure other transformations.
