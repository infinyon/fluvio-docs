...
InfinyOn Cloud installs the connectors automatically, all you need is to reference them by name in the configuration file.

You will need to use [`cdk`] to download and run the connector on your local machine.
