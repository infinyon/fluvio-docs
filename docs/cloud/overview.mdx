...
[Connector Development Kit (cdk)]: /docs/latest/fluvio/cli/cdk
...
[a growing number of connectors]: /docs/connectors/local/catalog/overview
[a random quote]: https://demo-data.infinyon.com/api/quote
[about Connectors in the Fluvio docs]: /docs/connectors/overview
...
[sign up here]: https://infinyon.com/request/sdf-onboarding/
