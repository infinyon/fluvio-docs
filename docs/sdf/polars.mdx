...
The polars [rust api](https://docs.rs/polars/0.36.2/polars/index.html) can be used when dataframe state is available.  For example, following snippet show performing polar operator on state that return dataframe.  Please refer to states [states](/docs/sdf/states) section for more details.
