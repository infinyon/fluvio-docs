...
Composition has two main components, [packages](/sdf#1-building-a-package) and [dataflows](/sdf#2-build-the-stateful-dataflow). You can build and test a package independently, then import it into a dataflow. For additional information, check out the [Composition] section.
