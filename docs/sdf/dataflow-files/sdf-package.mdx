...
The test command allows you to choose the function name and the input.

You may also test the package using the `cargo test` command.


## `sdf-package.yaml` template
...
[sdf]: /docs/sdf
[dataflows]: /docs/sdf/dataflow-yaml
