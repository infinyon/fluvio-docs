...
sidebar_position: 1
title: "Connectors"
description: "Connector's 4 steps of transformation"
---

There are 4 steps to the connector:

<img src="/img/docs/references/connectors/smart-connectors-extra.svg"
     alt="Connectors"
     width="600px" />
...
Powered by WebAssembly (also called wasm), [SmartModules](/docs/connectors/concepts/smartmodules/introduction) are pre-packaged or user-provided operations such as filters, maps, or aggregators that can be applied to records at various points in the streaming pipeline.
...
Use Connectors locally with [`cdk`](/docs/connectors/how-to/development/cdk/introduction) or start a connector on [InfinyOn Cloud](https://infinyon.cloud), and let us manage the infrastruture
