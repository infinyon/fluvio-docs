...
If running connectors with `CDK`, you can use the `--secrets` flag to pass a file with the secrets definition. See the [CDK documentation](/docs/connectors/how-to/development/cdk/introduction) for more information.
