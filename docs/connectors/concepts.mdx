...
Use Connectors locally with [`cdk`](/docs/connectors/cdk) or start a connector on [InfinyOn Cloud](https://infinyon.cloud), and let us manage the infrastruture
