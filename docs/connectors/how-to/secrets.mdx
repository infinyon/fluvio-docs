...
slug: /connectors/how-to/secrets
---
...
If running connectors with `CDK`, you can use the `--secrets` flag to pass a file with the secrets definition. See the [CDK documentation](/docs/connectors/cdk) for more information.
