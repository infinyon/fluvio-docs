...
slug: /connectors/how-to/development/cdk/secrets
---
...
More extensive examples of secrets in connectors can be seen in use with the [Http Source](/docs/connectors/inbound/http) connector and its repo https://github.com/infinyon/http-source-connector.

In the [next section](/docs/connectors/how-to/development/cdk/publish) we'll publish our connector to the Hub.
