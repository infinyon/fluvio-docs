...
More extensive examples of secrets in connectors can be seen in use with the [Http Source](/docs/connectors/reference/inbound/http) connector and its repo https://github.com/infinyon/http-source-connector.
