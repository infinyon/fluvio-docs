...
/>connectors/[SmartModules] page to learn how to apply a transformation or create a new one.
...
[Run connector on local machine]: ./run-connector/local.mdx
[Run connector in the cloud]: ./run-connector/cloud.mdx
