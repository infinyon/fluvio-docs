...
* Learn more about the connector's 4 steps of transformation in [core concepts](/docs/connectors/concepts/connectors)
* For the development of your own connectors, continue on to the [Connector Development Kit docs](/docs/connectors/how-to/development/cdk/introduction)
