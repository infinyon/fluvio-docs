...
" target="_blank">
    <img src="/img/docs/sdk/golang.svg" alt="Java SDK" height="64px" width="64px" />
  </a>
</div>
...
" target="_blank">
    <img src="/img/docs/sdk/elixir.svg" alt="Java SDK" height="64px" width="64px" />
  </a>
</div>
