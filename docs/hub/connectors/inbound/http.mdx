...
sidebar_position: 10
title: "HTTP"
description: "HTTP inbound connector polls, streams or listens for incoming HTTP requests and passes the data to fluvio."
---
...
[HTTP to SQL Pipeline]: /docs/latest/fluvio/tutorials/http-to-sql
