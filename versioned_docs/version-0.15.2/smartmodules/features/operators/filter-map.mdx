...
sidebar_position: 20
title: "Filter Map"
description: "FilterMaps are used to both transform and potentially filter records from a stream at the same time."
---
...
<img src="/img/docs/references/smartmodules/smartmodule-filtermap.svg" alt="SmartModule FilterMap" justify="center" height="190" />
...
Let's make sure our code compiles. If everything works as expected, there is a `.wasm` file generated in the target directory.
...
Test `filter` component to ensure non-matching records are eliminated:
...
Congratulations! :tada: Everything worked as expected!
...
- [Writing an aggregate to sum numbers]
