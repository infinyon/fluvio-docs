...
<img src="/img/docs/concepts/architecture/replica-election/election-leader-followers-brief.svg"
     alt="Replica Election"
     style={{ justify: 'center', maxWidth: '820px' }} />
...
<img src="/img/docs/concepts/architecture/replica-election/election-overview.svg"
  alt="Replica Election"
  style={{ justify: 'center', maxWidth: '820px' }} />
...
<img src="/img/docs/concepts/architecture/replica-election/election-connection.svg"
  alt="Replica Election"
  style={{ justify: 'center', maxWidth: '820px' }} />
 ...
 **Synchronization algorithm** collects the **LEOs**, computes the **HW**, and manages the **(LRS)**.
 ...
 <img src="/img/docs/concepts/architecture/replica-election/election-sync-overview.svg"
      alt="Synchronization Algorithm"
