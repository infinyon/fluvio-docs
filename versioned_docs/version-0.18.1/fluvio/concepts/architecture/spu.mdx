...
<img src="/img/docs/concepts/architecture/spu/spu-architecture.svg"
     alt="SPU Architecture"
     style={{ justify: 'center', maxWidth: '660px' }} />
...
6. Multicast Replica Info
    * receives Replica info from Follower Controller and unicasts to Leader SPU
...
[Election algorithm]: fluvio/concepts/architecture/replica-election.mdx
