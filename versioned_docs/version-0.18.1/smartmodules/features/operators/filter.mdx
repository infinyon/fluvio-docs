...
sidebar_position: 10
title: "Filter"
description: "The simplest type of SmartModule is a filter, which can examine each record in a stream and decide whether to accept or reject it."
---
...
<img src="/img/docs/references/smartmodules/smartmodule-filter.svg" alt="SmartModule Filter" justify="center" height="190" />
