...
sidebar_position: 30
title: "Map"
description: "SmartModule Maps are used to transform or edit each Record in a stream"
---
...
<img src="/img/docs/references/smartmodules/smartmodule-map.svg" alt="SmartModule Map" justify="center" height="190" />
