...
<img src="/img/docs/sdf/ss-tumbling-window.svg" alt="Tumbling Windows"
   className="docimg" width="600" />

**Sliding windows** are equal-sized, continuous and `overlapping` windows. Each record may be present in one or more window.

<img src="/img/docs/sdf/ss-sliding-window.svg" alt="Sliding Windows"
  className="docimg" width="600" />
