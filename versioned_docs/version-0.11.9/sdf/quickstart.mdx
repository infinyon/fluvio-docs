...
Composition has two main components, [packages](/docs/sdf#1-building-a-package) and [dataflows](/docs/sdf#2-build-the-stateful-dataflow). You can build and test a package independently, then import it into a dataflow. For additional information, check out the [Composition] section.
...
[here]: /docs/fluvio/#create-your-first-fluvio-cluster
