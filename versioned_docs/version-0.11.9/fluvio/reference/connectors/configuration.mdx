...
description: "Configuring Connectors"
slug: /fluvio/connectors/configuration
---
...
[connectors]: /docs/fluvio/connectors

See [Tutorials](/docs/tutorials/http-to-sql#connector-pipeline) for examples of using transforms.
