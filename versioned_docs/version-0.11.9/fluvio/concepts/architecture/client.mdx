...
slug: /fluvio/concepts/architecture/client
---
...
[Admin API]: /docs/fluvio/concepts/architecture/client#admin-api
[Producer API]: /docs/fluvio/concepts/architecture/client#producer-api
[Consumer API]: /docs/fluvio/concepts/architecture/client#consumer-api
