...
[Map]: /docs/connectors/smartmodules/transformations/map
...
[`fluvio consume`]: /docs/fluvio/cli/fluvio/consume#fluvio-consume
...
[Example 3]: /docs/fluvio/cli/fluvio/produce#produce-keyvalue-records-to-multiple-partitions
...
[`consuming`]: /docs/fluvio/cli/fluvio/consume
