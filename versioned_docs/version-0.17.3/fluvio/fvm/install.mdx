...
Before switching between versions, you need to install the version you want to switch to. You can install a `channel` or a specific version using `fvm install`.
