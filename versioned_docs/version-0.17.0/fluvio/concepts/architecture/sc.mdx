...
<img src="/img/docs/concepts/architecture/sc/sc-architecture.svg"
     alt="Architecture Components - SC"
...
<img src="/img/docs/concepts/architecture/sc/spu-groups.svg"
    alt="SPU Groups"
    style={{ justify: 'center', maxWidth: '740px' }} />
...
<img src="/img/docs/concepts/architecture/sc/partition-assignment.svg"
    alt="Partition Assignment"
    style={{ justify: 'center', maxWidth: '460px' }} />
...
<img src="/img/docs/concepts/architecture/sc/sc-workflows.svg"
     alt="SC Workflows"
...
<img src="/img/docs/concepts/architecture/sc/spu-controller.svg"
    alt="SPU Controller"
    style={{ justify: 'center', maxWidth: '440px' }} />
...
<img src="/img/docs/concepts/architecture/sc/topic-controller.svg"
...
<img src="/img/docs/concepts/architecture/sc/partition-controller.svg"
...
<img src="/img/docs/concepts/architecture/sc/connection-setup.svg"
    alt="Connection Manager"
    style={{ justify: 'center', maxWidth: '780px' }} />
...
[Topics CLI]: fluvio/cli/fluvio/topic.mdx