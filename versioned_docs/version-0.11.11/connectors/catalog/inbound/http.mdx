...
### Transformations
Fluvio HTTP Source Connector supports [Transformations](/docs/latest/fluvio/concepts/transformations). Records can be modified before sending to Fluvio topic.
