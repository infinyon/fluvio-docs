...
* Learn more about the connector's 4 steps of transformation in [core concepts](fluvio/concepts/transformations.mdx)
* For the development of your own connectors, continue on to the [Connector Development Kit docs](connectors/local/develop/introduction.mdx)
