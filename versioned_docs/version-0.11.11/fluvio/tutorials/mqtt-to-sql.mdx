...
Start SQL connector with JSON [transformation](/docs/latest/fluvio/concepts/transformations)
...
* [Transformations](/docs/latest/fluvio/concepts/transformations) in the `transforms` section of SQL Connector config are deliberately decoupled from connectors.
