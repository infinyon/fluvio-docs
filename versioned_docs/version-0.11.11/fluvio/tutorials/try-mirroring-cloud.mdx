...
Using your web browser, navigate to [https://infinyon.cloud/ui/signup](https://infinyon.cloud/ui/signup), where this experimental feature is available.
...
```bash
  ...
  c7f891c9-f1f9-4d28-b181-9777d8d07731  router.infinyon.cloud:9003  Online  1s
```
