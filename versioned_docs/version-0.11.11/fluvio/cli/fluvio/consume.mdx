...
[`fluvio produce` examples]: fluvio/cli/fluvio/produce.mdx
[`fluvio topic create`]: fluvio/cli/fluvio/topic.mdx#fluvio-topic-create
[filter example]: smartmodules/transformations/filter.mdx
[in our GitHub repo]: https://github.com/infinyon/fluvio/tree/master/smartmodule/examples/filter_json