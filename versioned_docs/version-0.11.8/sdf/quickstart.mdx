...
#### Overview for `preview-10`

Preview 10 is a major release that includes several new features and improvements. The main feature is [composition], which allows you to create individual packages and import them to create dataflows.
...
<img src="/img/docs/sdf/preview-10.jpg" alt="Preview Example"
    className="docimg" style={{ border: 'solid #ddd' }} width="700" />
...
Composition has two main components, [packages](/docs/sdf/quickstart#1-building-a-package) and [dataflows](/docs/sdf/quickstart#2-build-the-stateful-dataflow). You can build and test a package independently, then import it into a dataflow. For additional information, check out the [Composition] section.
...
For additional examples, check out [stateful-dataflows-examples](https://github.com/infinyon/stateful-dataflows-examples) in github. The examples cover additional functionality shipped in prior preview releases.
