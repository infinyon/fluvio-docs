...
[Generate a Connector]: /docs/connectors/local/cdk/generate
[Build and Test]: /docs/connectors/local/cdk/build
[Start and Shutdown]: /docs/connectors/local/cdk/start-shutdown
[Troubleshooting]: /docs/connectors/local/cdk/secrets
[Secrets]: /docs/connectors/local/cdk/secrets
[Publish to Connector Hub]: /docs/connectors/local/cdk/publish
[Use Examples in Github]: /docs/connectors/local/cdk/github-examples
