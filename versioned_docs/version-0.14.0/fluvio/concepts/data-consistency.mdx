...
See more details about the [Synchronization Algorithm].
...
```
<!-- TODO recommend change read-committed to ack_committed -->
...
[Read details]: fluvio/concepts/delivery-semantics.mdx#at-least-once 