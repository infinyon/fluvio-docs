export function Card(props: {
  ...
  return (
    <article className={cardClass.join(' ')}>
      <figure className="m-0 bg-gray-50 dark:bg-zinc-900 border border-solid border-gray-100 dark:border-zinc-950 rounded flex items-center justify-center p-6 md:py-12 w-11/12 md:max-w-[500px]">
