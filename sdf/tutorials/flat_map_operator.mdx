---
sidebar_position: 10
title: "Flat Map Operator"
description: "Flat Map Operator Tutorial"
---
...
Below is an example of a tranform function using flat-map. The function takes the inputted string and splits in half. Both halves are inserted into the sink.  
