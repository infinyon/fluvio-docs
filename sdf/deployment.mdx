...
Once a worker is selected, you can deploy the dataflow using the `deploy` command:
...
To delete a dataflow, you can use the `dataflow delete` command.

After you delete the dataflow, it will no longer appear in the dataflow list.
