...
<img src="/docs/images/stateful-dataflows/_release-app.jpg" alt="Preview Example"
...
Composition has two main components, [packages](#building-a-package) and [dataflows](#build-the-stateful-dataflow). You can build and test a package independently, then import it into a dataflow. For additional information, check out the [Composition] section.
