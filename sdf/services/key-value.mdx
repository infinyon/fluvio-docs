...
* <a href="https://github.com/infinyon/stateful-dataflows-examples/tree/main/primitives/key-value" target="_blank" rel="nofollow" >Key-Value Examples (github)</a>

[key-value streams]: https://fluvio.io/cli/client/produce/#produce-keyvalue-records-to-multiple-partitions
[map]:  /sdf/services/operators/#map
[filter]: /sdf/services/operators/#filter
[filter-map]: /sdf/services/operators/#filter-map
[flat-map]: /sdf/services/operators/#flat-map
[assign-key]: /sdf/services/operators/#assign-key
[assign-timestamp]: /sdf/services/operators/#assign-timestamp
[update-state]: /sdf/services/operators/#update-state
