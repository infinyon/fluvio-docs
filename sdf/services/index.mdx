...
<img src="/docs/images/stateful-dataflows/service-Architecture.png" alt="Service Architecture"
...
<img src="/docs/images/stateful-dataflows/service-partitions.png" alt="Service Partitions" style={{ display: 'block', margin: '0 auto' }} width="720" />
...
<img src="/docs/images/stateful-dataflows/service-window.png" alt="Window Processing"
...
[Operators]: /sdf/services/operators
[SDF]: /sdf
[merge]: /sdf/services/merge
[split]: /sdf/services/split
[states]: /sdf/services/states
[Operators Section]: /sdf/services/operators
[dataflow.yaml]: sdf/dataflow-yaml
[sdf-package.yaml]: /sdf/sdf-package-yaml
[timestamp operator section]: /sdf/services/operators#assign-timestamp
