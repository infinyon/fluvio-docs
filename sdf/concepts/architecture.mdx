...
[Services], while omitted from the diagram, define the composition of a subsection of the data-pilelines. Services define the data source, chain of operations, state objects, and the destination.
